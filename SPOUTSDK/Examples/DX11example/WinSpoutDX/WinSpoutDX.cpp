...
=========================================================================
   ...
   A simple Windows Desktop Application project generated by Visual Studio
   ...
   Compare with DirectX 11 examples Tutorial04 and Tutorial07.
...
INT_PTR CALLBACK About(HWND hDlg, UINT message, WPARAM wParam, LPARAM lParam)
{
    ...
    case WM_INITDIALOG:
		...
		strcat_s(about, 1024, "\n\n\n");
		strcat_s(about, 1024, "Basic Windows Spout receiver example\n");
		strcat_s(about, 1024, "using the SpoutDX class to receive to\n");
