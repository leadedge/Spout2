...
void ofApp::doMessagebox(int item)
{
	...
	// SpoutMessageBoxWindow provides a window handle for the SpoutMessageBox functions
	// which subsequently open centred on the window 
	//     spoutMessageBoxWindow(HWND hwnd)
	...
	if (item == 'b') {
		...
		str += "SpoutMessageBoxWindow provides a window handle for the\n;";
		str += "dialogs to open centred on the window.\n";
	...
	if (item == 'k') {
		...
		str += "    }\n\n";
		str += "Properties are the same as the edit control\n";
