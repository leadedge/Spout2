...
#include "..\SpoutDX9.h" // for D3D9ex sender functions
...
INT WINAPI wWinMain( HINSTANCE hInst, HINSTANCE, LPWSTR, INT )
{
	...
	// The sender uses the backbuffer, so set the desired size
	// and adjust the window size to it
	RECT rc = { 0, 0, 512, 512 };
	...
	sender.SetSenderName("Meshes DX9 sender");
