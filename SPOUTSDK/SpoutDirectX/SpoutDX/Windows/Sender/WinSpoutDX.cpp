                     ...
                     _In_ int       nCmdShow)
{
	...
	g_hBitmap = (HBITMAP)LoadImageA(NULL, "koala-on-tree-640.bmp", IMAGE_BITMAP, 0, 0, LR_LOADFROMFILE);
	if (!g_hBitmap) {
	...
	sender.SetSenderName("WinSpoutDX sender");
	// Adjust the caption to show the sender name
    ...
    case WM_COMMAND:
        {
            ...
            switch (wmId)
            {
				...
				{
					std::string str = "\n                        WinSpoutDX\n\n";
					str += "      Windows Spout image sender example\n";
